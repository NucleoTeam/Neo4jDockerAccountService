        ...
        parallel(
          ...
          "QA Release": {
            script {
              ...
              slackSend color: '#f4b942', message: "[${env.JOB_NAME} ${env.BUILD_NUMBER}][QA] Quality assurance ticket created (<http://50.115.119.76:3000/browse/"+newIssue.data.key+"|JIRA_Ticket>)"
            }
