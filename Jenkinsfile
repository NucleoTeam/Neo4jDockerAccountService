...
docker build -t nucleoteam/neo4jdockeraccountservice:latest ./'''
    ...
    stage('Deploy') {
      steps {
        rancher(environmentId: '1a5', ports: '8000:8080', environments: 'testapp-AccountManager-1', confirm: true, image: 'nucleoteam/neo4jdockeraccountservice:latest', service: 'testapp/AccountManager', endpoint: 'http://212.47.248.38:8080/v2-beta', credentialId: 'rancherLoginCredentials')
      }
    }
  }
}